...
def main(args):
    ...
    wandb.init(project='np4a_eval_for_small', reinit=True, entity='virtualkss-team', name=task_name)
...
def train_bc(train_dataloader, val_dataloader, config, path2ckpt=None):
    ...
    # save initial policy ckpt
    ckpt_path = os.path.join(ckpt_dir, f'policy_initial.ckpt')
