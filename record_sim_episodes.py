...
from scripted_policy import PickAndTransferPolicy, InsertionPolicy, PickAndTransferNoisyPolicy, PickAndTransferSmallNoisyPolicy, InsertionNoisyPolicy
...
def main(args):
    ...
    elif task_name == 'sim_transfer_cube_small_noisy_scripted':
        policy_cls = PickAndTransferSmallNoisyPolicy
